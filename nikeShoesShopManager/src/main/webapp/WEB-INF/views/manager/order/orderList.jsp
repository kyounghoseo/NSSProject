...
<!-- <link rel="stylesheet" type="text/css"
	href="/customer/resources/css/main.css"> -->
<link rel="stylesheet" type="text/css"
...
<body>
	...
	<div id="wrap">
		...
		<table class="table table-bordered"
			style="height: 100%; margin-top: 3%;" cellspacing="0" cellpadding="0">
			<tbody>
				<tr>
					<th>주문결제</th>
					<th>배송중/완료</th>
				...
				<tr style="text-align: center;">
					<td style="color: blue;">${orderCount }건</td>
					<td style="color: orange;">${shipCount }건</td>
					<td style="color: red;">${cancleCount }건</td>
				</tr>
			</tbody>
		</table>
		<div id="d_control">
			<div id="d_search">
				<form id="f_search">
					<p style="float: left; font-family: initial; font-weight: bold;">날짜별
						조회</p>
					<div style="clear: both; float: left; width: 80%;">
						...
						<input type="button" id="search" value="조회"> <input
							type="hidden" name="page" id="page" value="${data.page }">
						<input type="hidden" name="pageSize" id="pageSize"
							value="${data.pageSize }"> <input type="hidden"
							name="order_check" class="order_check"
							value="${data.order_check }">
					</div>
				</form>
			</div>
			<div id="d_radio">
	...
	<div id="dialog" title="보내시는 운송장 번호를 입력해주세요.">
		<form name="detailForm" id="detailForm">
			<input type="hidden" name="orderGroup" id="orderGroup"> <input
