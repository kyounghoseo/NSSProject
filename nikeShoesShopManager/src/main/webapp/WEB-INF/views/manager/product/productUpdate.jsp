		...
		<table class="table table-bordered" style="height: 200px;" width="100%" border="1">
			...
			<tbody>
				<tr>
					...
					<td ><input type="text" id="productName" name="productName" value="${updateData.productName }"  /></td>
				...
				<tr>
					...
					<td ><input type="text" id="productCode" name="productCode" value="${updateData.productCode }" /></td>
					<td class="ac"><label>상품가격</label></td>
					<td ><input type="text" id="productPrice" name="productPrice" value="${updateData.productPrice }" /></td>
				</tr>
				
				<tr>
					<td  class="ac"><label>상품색상</label></td>
					<td ><input type="text" id="productColor" name="productColor" value="${updateData.productColor }" /></td>
						<td  class="ac"><label>상품정보</label></td>
					<td ><input type="text" id="productInfo" name="productInfo" value="${updateData.productInfo }" /></td>
				...
				<td class="ac"><label>상품이미지</label></td>
					...
					<img  src="/manager/uploadStorage/${updateData.productMainImage }">
					<p id="aa"></p></div>
					</div>
					...
					<img src="/manager/uploadStorage/${updateData.productDetailImage1 }">
					<p id="aa1"></p></div>
					</div>
				...
				<tr class="tr_img"><td class="ac"><label>상품상세이미지2</label></td>
					...
					<img src="/manager/uploadStorage/${updateData.productDetailImage2 }">
					<p id="aa2"></p></div>
					</div>
					...
					<img src="/manager/uploadStorage/${updateData.productFile }">
					<p id="aa3"></p></div>
					</div>
