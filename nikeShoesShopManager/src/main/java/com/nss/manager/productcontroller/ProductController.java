...
public class ProductController {
	...
	public String boardInsert(@ModelAttribute ProductVO pvo, HttpServletRequest request)
	...
	public String boardUpdate(@ModelAttribute ProductVO pvo, HttpServletRequest request)
		...
		if (!pvo.getDetailImage1().isEmpty()) {
			 ...
			 * else{ pvo.setProductDetailImage1(""); }
			 */
		if (!pvo.getDetailImage2().isEmpty()) {
			 ...
			 * else{ pvo.setProductDetailImage2(""); }
			 */
